      ...
      <div className="mx-auto my-32 flex h-auto max-w-4xl flex-wrap items-center lg:my-0 lg:h-screen">
        ...
        >
          <div className="p-4 text-center md:p-12 lg:text-left">
            ...
            />
            <h1 className="pt-8 text-3xl font-bold lg:pt-0">Your Name</h1>
        ...
        <div className="relative w-full lg:w-2/5">
          <Image
            alt="logo"
            layout="fill"
            src="https://source.unsplash.com/featured/600x600"
            className="hidden h-10 w-10 rounded-full shadow-2xl lg:block lg:rounded-lg"
          />
        </div>
