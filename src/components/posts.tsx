...
const Posts = () => {
  return (
    <section className="body-font mt-8 overflow-hidden bg-gray-800 text-gray-400">
      <div className="container mx-auto px-5 py-24">
        <div className="-m-12 flex flex-wrap">
          ...
          <div className="flex flex-col items-start rounded-3xl bg-gray-900 p-12 md:w-1/2">
            <span className="inline-block rounded bg-gray-800 py-1 px-2 text-xs font-medium tracking-widest text-gray-400 text-opacity-75">
              CATEGORY
            </span>
            <h2 className="title-font mt-4 mb-4 text-2xl font-medium text-white sm:text-3xl">
